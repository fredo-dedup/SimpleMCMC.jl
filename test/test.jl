...
@mult deriv1    SimpleMCMC.logpdfWeibull(1, 2, x)    {-1., 0., 1., 10.}
@mult deriv1    SimpleMCMC.logpdfWeibull(0.5, x, 3)  {0.1, 1., 10.}
@mult deriv1    SimpleMCMC.logpdfWeibull(x, 4, 10)   {0.1, 1., 10.}

@mult deriv1    SimpleMCMC.logpdfUniform(-1, 1, x)     {-.1, 0., 2.9}
@mult deriv1    SimpleMCMC.logpdfUniform(0, x, 1.0)    {0.5, 1., 10.}
@mult deriv1    SimpleMCMC.logpdfUniform(x, 0.5, 0.2)  {0., -1., 0.3}
